...
<template>
  <div class="fixed inset-0 bg-black/80 flex items-center justify-center z-50 animate-fade-in">
    <div class="bg-light-bg dark:bg-dark-bg rounded-2xl p-6 w-full max-w-md mx-4 animate-scale-in border border-light-border dark:border-dark-border">
      <!-- Header -->
      ...
      <div class="space-y-5">
        ...
        <div>
          ...
          <input 
            ...
            class="w-full px-4 py-3 bg-light-surface dark:bg-dark-surface border border-light-border dark:border-dark-border rounded-lg text-lightText-primary dark:text-white placeholder-lightText-muted dark:placeholder-text-muted focus:border-pomodo-orange focus:outline-none transition-colors"
          />
        </div>
          ...
          <div class="grid grid-cols-8 gap-2">
            <button
              ...
              :class="[
                ...
                selectedColor === color ? 'ring-2 ring-lightText-primary dark:ring-white ring-offset-2 ring-offset-light-bg dark:ring-offset-dark-bg' : ''
              ]"
        ...
        <div>
          ...
          <div class="flex items-center gap-4 bg-light-surface dark:bg-dark-surface rounded-lg px-3 py-2 w-fit">
            <button 
              @click="dailyGoal = Math.max(1, dailyGoal - 1)"
              class="w-8 h-8 flex items-center justify-center text-pomodo-orange hover:bg-light-border dark:hover:bg-dark-border rounded transition-colors"
            >
              <Minus :size="16" />
            </button>
            <span class="text-lightText-primary dark:text-white min-w-[80px] text-center">{{ dailyGoal }} sessions</span>
            <button 
              @click="dailyGoal++"
        ...
        <div class="flex items-center gap-3">
          ...
          <label class="text-lightText-primary dark:text-white cursor-pointer" @click="trackStatistics = !trackStatistics">
