    ...
    describe("buildRRuleAndUntil", () => {
        ...
        describe("Simple Recurrence Types", () => {
            it("builds DAILY recurrence rule", () => {
                const result = buildRRuleAndUntil(
                    { type: RecurrenceType.DAILY, repeatUntilType: RepeatUntilType.REPEAT_FOREVER },
                    baseStartTime
                );
            ...
            it("builds WEEKDAYS recurrence rule", () => {
                const result = buildRRuleAndUntil(
                    { type: RecurrenceType.WEEKDAYS, repeatUntilType: RepeatUntilType.REPEAT_FOREVER },
                    baseStartTime
                );
            ...
            it("builds WEEKLY recurrence rule based on start day", () => {
                // Friday = day 5
                const result = buildRRuleAndUntil(
                    { type: RecurrenceType.WEEKLY, repeatUntilType: RepeatUntilType.REPEAT_FOREVER },
                    baseStartTime
                );
            ...
            it("builds MONTHLY recurrence rule", () => {
                const result = buildRRuleAndUntil(
                    { type: RecurrenceType.MONTHLY, repeatUntilType: RepeatUntilType.REPEAT_FOREVER },
                    baseStartTime
                );
            ...
            it("builds YEARLY recurrence rule", () => {
                const result = buildRRuleAndUntil(
                    { type: RecurrenceType.YEARLY, repeatUntilType: RepeatUntilType.REPEAT_FOREVER },
                    baseStartTime
                );
        ...
        describe("Custom Recurrence Types", () => {
            ...
            it("builds custom YEARLY recurrence", () => {
                ...
                expect(result.rrule).toBe("FREQ=YEARLY;INTERVAL=2;BYMONTH=3;BYMONTHDAY=15");
            });
        });
