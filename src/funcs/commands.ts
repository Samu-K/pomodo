...
async categoriesAddCategory(cat: Category) : Promise<Result<number, AppError>> {
    ...
    else return { status: "error", error: { message: String(e) } };
}
},
...
// 						listen: (arg: unknown) => window.listen(name, arg as any),
// 						once: (arg: unknown) => window.once(name, arg as any),
// 						emit: (arg: unknown) => window.emit(name, arg as any),
// 					}),
// 					get: (_, command: keyof __EventObj__<any>) => {
// 						switch (command) {
// 							case "listen":
// 								return (arg: unknown) => TAURI_API_EVENT.listen(name, arg as any);
// 							case "once":
// 								return (arg: unknown) => TAURI_API_EVENT.once(name, arg as any);
// 							case "emit":
// 								return (arg: unknown) => TAURI_API_EVENT.emit(name, arg as any);
// 						}
// 					},
// 				});
// 			},
