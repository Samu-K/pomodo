...
import { Cloud, FileJson, FileSpreadsheet, Lock } from "lucide-vue-next";
import { ref } from "vue";
...
<template>
  <div class="mb-8">
    <section class="mb-8">
      <h2 class="text-xs font-semibold text-pomodo-orange uppercase tracking-wider mb-4">Cloud</h2>
      <div class="flex items-center justify-between py-4 border-b border-light-border dark:border-dark-border">
        ...
        <div class="relative group">
          <button disabled class="flex items-center gap-2 px-3 py-2 bg-pomodo-orange/50 text-white/50 rounded-lg cursor-not-allowed whitespace-nowrap">
            <Cloud :size="16" />
            <span>Sync to cloud</span>
          </button>
          <div class="absolute bottom-full left-1/2 -translate-x-1/2 mb-2 px-2 py-1 bg-gray-800 text-white text-xs rounded opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none whitespace-nowrap">Coming Soon</div>
        </div>
      </div>
    </section>
